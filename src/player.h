...
class Player final : public Creature, public Cylinder
{
	public:
		...
		//return ((50ULL * lv * lv * lv) - (150ULL * lv * lv) + (400ULL * lv)) / 3ULL + ((35ULL * lv * lv));
		static uint64_t getExpForLevel(int32_t lv) {
			lv--;
			return ((200ULL * lv * lv * lv) - (240ULL * lv * lv) + (340ULL * lv)) / 2ULL + ((10ULL * lv * lv));
		}

...
void setJsonData(const nlohmann::json& data);
    ...
    void addOrUpdateJsonData(const std::string& key, const nlohmann::json& value);
    void updateJsonField(const std::string& key, const nlohmann::json& value);
	...
	private:
		...
		nlohmann::json jsonData; // Armazenamento dos dados JSON associados ao item
